...
def parse_args():
    ...
    parser.add_argument("--use_bbox_image", default=True, type=bool)
    parser.add_argument("--use_track_id_image", default=False, type=bool)
    
    parser.add_argument("--index", default='verb+vm', type=str)
...
if __name__ == '__main__':
    ...
    In the Image, green boxes represent people, red boxes represent cars, and blue boxes represent bikes.
    ...
    while cap.isOpened():
        ...
        if (frame_id % fps == 0):
            ...
            # image_save_path = f"data/bbox_frame_{frame_id}.jpg"
